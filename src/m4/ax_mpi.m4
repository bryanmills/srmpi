...
AC_LANG_CASE([C], [
	...
	AC_PATH_PROGS(MPICC, mpicc hcc mpxlc_r mpxlc mpcc cmpicc, $CC,
		[${with_redstorm_dist}/install/mpich2-64/GP2/bin:$PATH]
	)
	ax_mpi_save_CC="$CC"
	CC="$MPICC"
	AC_SUBST(MPICC)
...
# This was AC_CHECK_FUNCS but I am trying to get it to
# automaticly compile and include my MPI_Reduce local
# if it does not exist
AC_LANG_CASE([C], [AC_REPLACE_FUNCS([MPI_Reduce_local])])
